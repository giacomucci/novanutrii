...
class Mageplace_Callforprice_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function prepareReplacement()
    {
		...
		$replacement .= "</span>";
		$replacement .= "<a href='https://goo.gl/1UK966' class='contact-item whatsapp button'>WhatsApp</a>";
		$replacement .= "<a href='#openCalled' class='contact-item wecall button'>Nós ligamos para você</a>";
		$replacement .= "<a href='mailto:adm@nutrii.com.br' class='contact-item email'>adm@nutrii.com.br</a>";
		$replacement .= "<div class='contact-item tel'><a href='tel:.551149943555'>(11)4994-3555</a><br/><a href='tel:08007735355'>0800 773 5355</a></div>";
		$replacement .= "</div>";
    ...
    public function prepareReplacementList()
    {
		...
		$replacement  = "<div id='contact' class='ligue-para-mim list-ligue'>";
