...
function buscaCep(quale) {
	...
	jQuery('input[name*="' + quale + '[street][]"]').val('');
	jQuery('input[name*="' + quale + '[street][4]"]').val('');
	jQuery('input[name*="' + quale + '[city]"]').val('');
        ...
        if (cep != '' && cep.length == 8) {
            ...
            jQuery.getScript("/onestepcheckout/ajax/busca_cep?cep="+ cep + "", function() {
                ...
                if (resultadoCEP["resultado"] != 0) {
                    ...
                    //jQuery('input[name*="street[]"]').val(unescape(resultadoCEP["tipologradouro"]) + " "+ unescape(resultadoCEP["logradouro"]));
                    jQuery('input[name*="street[4]"]').val(unescape(resultadoCEP["bairro"]));
                    jQuery('input[name*="city"]').val(unescape(resultadoCEP["cidade"]));
                    jQuery('input#cidade_fake').val(unescape(resultadoCEP["cidade"]));
        ...
        if (cep != '' && cep.length == 8) {
            ...
            jQuery.getScript("/onestepcheckout/ajax/busca_cep?cep="+ cep + "", function() {
                ...
                if (resultadoCEP["resultado"] != 0) {
                   ...
                   // jQuery('input[name*="' + quale + '[street][]"]').val(unescape(resultadoCEP["tipologradouro"]) + " "+ unescape(resultadoCEP["logradouro"]));
