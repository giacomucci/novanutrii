 ...
 */
class Oitoo_Cielo_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function getJurosAmount($parcela,$valortotal){
        $parcelasSemJuros       = Mage::getStoreConfig('payment/apelidocielo/parcelas_sem_juros');
        $numeroMaximodeParcelas = Mage::getStoreConfig('payment/apelidocielo/num_max_parc');
        $juros_parcela          = Mage::getStoreConfig('payment/apelidocielo/juros_parcela');
        $jurosAmount = 0;
    ...
    public function getDiscountAmount($parcela,$valorTotal){
      if($parcela == 1){
         $desconotavista = Mage::getStoreConfig('payment/apelidocielo/valor_desconto_avista');
